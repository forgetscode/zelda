...
const Reclaim: NextPage = () => {
    ...
    <>
        ...
        <Toaster/>
        <div className='bg-[#101010] flex h-full  ml-16 pt-16'>
            <div className='flex flex-col pt-16 pb-16 mx-auto md:max-w-[800px]'>
                <h1 className='transition-all w-full text-6xl md:text-8xl text-teal-500 font-bold text-center'>
                Reclaim.
                </h1>
                <div className='mx-24 space-y-8 text-center'>
                    <div className='flex flex-row w-full  pl-12 sm:pl-36 md:pl-48'>
                        <p className='pt-8 text-2xl md:text-4xl text-bold text-white font-manrope'>
                            {"Data "}
                        </p>
                        <Typed
                        className='pl-1 md:pl-2 pt-8 text-2xl md:text-4xl text-bold font-manrope text-teal-500 '
                        strings={[' has a cost.', ' is time.', '', '',' is $.' ]} typeSpeed={120} backSpeed={100} loop/>
                    </div>
                    <p className='max-w-20 text-teal-500 italic text-xs md:text-sm md:text=md'>
